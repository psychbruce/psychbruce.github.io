...
```{r add favicon, echo=FALSE, message=FALSE, warning=FALSE}
library(htmltools)
tagList(
  tags$link(rel="shortcut icon", type="image/x-icon", href="img/favicon.ico?")
)
```
...
#### 2017~now - **_Ph.D._** in Social Psychology
